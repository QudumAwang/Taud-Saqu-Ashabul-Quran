...
<body class="kelas-page">
    ...
    <div class="container-fluid container-xl position-relative d-flex align-items-center">
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
            ...
            <li><a href="kelas.php" class="active">Kelas</a></li>
  ...
  <main class="main">
      ...
      <div class="heading">
        <div class="container">
          <div class="row d-flex justify-content-center text-center">
            <div class="col-lg-8">
              <h1>Kelas</h1>
              <p class="mb-0">Kelas yang tersedia di Taud Saqu Ashabul Quran.</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <section id="kelas" class="section kelas">
      <div class="container">
        <div class="row gy-5">
          <?php
              include('config.php');
      ...
      <div class="row gy-4">
        <div class="col-lg-4 col-md-6 footer-tentang">
          ...
          <div class="footer-kontak pt-3">
            ...
            <p class="mt-3"><strong>Telpon:</strong> <span><a href="https://wa.me/6281259417460"><a href="https://wa.me/6281259417460">+6281259417460</a></span></p>
